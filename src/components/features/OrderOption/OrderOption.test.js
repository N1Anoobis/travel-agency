...
describe('Component OrderOption', () => {
  it('should render without crashing', () => {
    const component = shallow(<OrderOption typy='Lorem ipsum'  name='Lorem ipsum'/>);
  ...
  it('should check if props name is passed correctly', () => {
    const expectedTitle = 'Lorem ipsum';
    const expectedType = 'dropdown';
    const component = shallow(<OrderOption type={expectedType} name={expectedTitle}/>);
    expect(component.find('h3').at(0).text()).toEqual(expectedTitle);
  });
});
...
for(let type in optionTypes){
  describe(`Component OrderOption with type=${type}`, () => {
    ...
    switch (type) {
      ...
      case 'icons': {
        /* tests for icons */
        it('contains div with class icon and input inside', () => {
      ...
      case 'checkboxes': {
        ...
        it('contains div with class checkboxes', () => {
          ...
          const emptyInput = checkbox.find('input[value=""]');
          expect(emptyInput).toBeTruthy();
          
          const input = checkbox.find('input').not('[value=""]');
